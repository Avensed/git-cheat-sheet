...
git checkout -f <file>  # отменить незакомиченные изменения в файле
# Делает то же, что и две команды выше (один из способов):
git checkout -f HEAD    # отменить незакомиченные изменения в файле
# Делает то же, что и три команды выше (один из способов):
git checkout -f         # отменить незакомиченные изменения в файле
```
