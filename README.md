...
```bash
mv <file> <directory>      # переместить файл в указанную директорию
Пример:                    mv dev.txt /home/user/docs/
mv <directory> <directory> # переместить директорию в другую директорию
Пример:                    mv project /home/user/test/
```

### Команды для фиксации переименования
```bash
mv <file> <file>           # переименовать файл и проиндексировать
Пример:                    mv old.txt new.txt
mv <directory> <directory> # переименовать директорию и проиндексировать
