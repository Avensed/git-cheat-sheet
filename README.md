...
git log --oneline                 # показать историю коммитов в одну строку на коммит
git log --graph                   # показать историю коммитов в виде графа с коммитами
git log --oneline --first-parent  # показать историю коммитов по 1-ой родительской ветке
...
git commit -am ""            # проиндексировать и закоммитить файлы с описанием
...
```bash
git checkout -- <file>  # отменить незакомиченные изменения в файле
git reset <file>        # удалить определенный файл из индекса
...
```bash
git cherry-pick <commit>             # применить изменения из коммита в текущую ветку
git cherry-pick --edit <commit>      # применить изменения из коммита с изменением сообщения
git cherry-pick --no-commit <commit> # применить изменения из коммита без создания нового коммита
